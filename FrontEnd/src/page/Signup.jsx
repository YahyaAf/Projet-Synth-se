...
export default function Signup() {
  ...
  <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
    ...
    <div>
      ...
      <div>
        <button type="submit" className="flex w-full justify-center rounded-md bg-orange-300 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-orange-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-orange-400">Sign up</button>
      </div>


    </form>
    <p className="mt-3 text-center text-sm text-gray-500">
            <Link className="font-semibold leading-6 text-orange-300 hover:text-orange-400" to="/login">already have an account</Link>
        </p>
  </div>
</div>
    </>
